...
public class ResearchReportsBean {
	...
	private static void generateConditionFile(File filehandle) {
		try {
			...
			writer.append(',');
			/*
			 * writer.append("Rx Given1"); writer.append('\n');
			 * writer.append("Rx Given2"); writer.append(',');
			 * writer.append("Rx Given3"); writer.append(',');
			 * writer.append("Rx Given4"); writer.append(',');
			 * writer.append("Rx Given5");
			 */
			writer.append('\n');

			for (int i = 0; i < dbencounter.size(); i++) {
				writer.append(String.valueOf(dbencounter.get(i)
						.getEncounterID()));
				writer.append(',');
				writer.append(dbencounter.get(i).getCondition1());
				writer.append(',');
