...
public class UserInterface {
	  ...
	  */
	   ...
	   * Sets the user name
	   * 
	   * This function sets the user's name to what is specified in the parameter.
	   * 
	   */
	   ...
	   * 
	   * This function returns a String message describing the result of the login attempt.
	   * 
	   */
	   ...
	   * Checks password
	   * 
	   * This method checks the password to see if it matches the string "raptor" and sets the login attempt result string based on the comparison.
	   * 
	   */
